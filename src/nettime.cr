...
task_id = Task.from_json(request2.body).taskId

sleep 1

request4 = Crest.get("http://192.168.1.200:8091/api/async/response", params: { "taskid" => task_id }, cookies: request2.cookies)
